# Django settings for opal_vue project.
import os
...
SECRET_KEY = ')l%44-7w5izmljrpc_ezq84ia_191gz!k#o3l9g&=#7b7nzex^'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'context_processors': [
                ...
                'opal_vue.context_processors.schema',
            ],
            'loaders': LOADERS
        },
    },
...
WSGI_APPLICATION = 'opal_vue.wsgi.application'
...
DEFAULT_DOMAIN = 'http://opal_vue.com/'


# ========== PROJECT ==========
OPAL_BRAND_NAME = 'opal_vue'
